...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: Leave a Star ⭐
      link: https://github.com/V-Songbird/gemini-mcp-tool
...
features:
  ...
  - icon: 🤝
    ...
    details: Built by developers, for developers. Open source and community driven.
  - icon: 🔌
    title: MCP Standards
    details: |
...
For installation and setup instructions, please refer to our [GitHub repository](https://github.com/V-Songbird/gemini-mcp-tool#readme) which contains the most up-to-date installation guide.
