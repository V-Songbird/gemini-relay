# Gemini MCP Tool — Agent Integration & Capability Guide
...
`gemini-mcp-tool` connects your agentic runtime directly to Google's **Gemini 3.8 Flash** and **Gemini 3.1 Pro** engines via the modern **Antigravity CLI** (`agy`) backend (and legacy `gemini` CLI).
