...
> (`agy`) ships in `gemini-relay` 1.1.8. The `agy` backend becomes the default on
> **2026-06-18**, the day Google retires the Gemini CLI for free, Pro, and Ultra users.
> Tracking: [discussion #90](https://github.com/V-Songbird/gemini-relay/discussions/90).
...
`gemini-relay` is, at its core, a thin, hardened wrapper that shells out to the
