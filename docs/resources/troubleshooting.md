...
claude mcp add gemini-cli -- gemini-relay

# Method 2: Use --yes instead of -y
claude mcp add gemini-cli -- npx --yes gemini-relay

# Method 3: Remove the -y flag entirely
claude mcp add gemini-cli -- npx gemini-relay
```
...
1. Check [GitHub Issues](https://github.com/V-Songbird/gemini-relay/issues)
2. Enable debug mode
