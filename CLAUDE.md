...
> **Note for Claude Code:** This file provides runtime instructions for developing, testing, and using `gemini-relay`. Read `docs/AGENT_GUIDE.md` for complete architectural recipes and advanced usage patterns.
