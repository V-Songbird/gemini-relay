# Contributing to Gemini Relay

Thanks for your interest in contributing! This project welcomes issues and pull requests.

## Reporting issues

- Search [existing issues](https://github.com/V-Songbird/gemini-relay/issues) first.
- Include your OS, Node.js version, Gemini / Antigravity CLI version, and MCP client
  (Claude Code, Claude Desktop, etc.), plus exact error output if any.

## Development setup

```bash
git clone https://github.com/V-Songbird/gemini-relay.git
cd gemini-relay
npm install
npm run build
npm test
...
[v-songbird.github.io/gemini-relay](https://v-songbird.github.io/gemini-relay/). Doc fixes are always welcome.
